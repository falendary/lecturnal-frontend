...
var TextJustifyComponent = (function () {
    function TextJustifyComponent() {
        this.update = new core_1.EventEmitter();
    }
    TextJustifyComponent.prototype.wrapSelected = function () {
        document.execCommand('justifyFull', false, null);
    };
    return TextJustifyComponent;
}());
__decorate([
...
TextJustifyComponent = __decorate([
    core_1.Component({
        ...
        template: 'text-justify.component.html'
    })
], TextJustifyComponent);
exports.TextJustifyComponent = TextJustifyComponent;

//# sourceMappingURL=text-justify.component.js.map
